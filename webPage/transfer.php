...
<section class="bank">
  <div class="bank-text">
    ...
    <form action="transfer.php" method="post">
        ...
        <input type="text" name="source_user_id" required placeholder="Source User ID">

        <label for="source_account_id">Source Account ID:</label>
        <input type="text" name="source_account_id" required placeholder="Source Account ID">

        <label for="destination_user_id">Destination User ID:</label>
        <input type="text" name="destination_user_id" required placeholder="Destination User ID">

        <label for="destination_account_id">Destination Account ID:</label>
        <input type="text" name="destination_account_id" required placeholder="Destination Account ID">
