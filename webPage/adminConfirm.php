...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/adminConfirm.css">
...
//see what the admin chose
  ...
  header('Location: ../webPage/adminConfirm.php');
  exit();
}
...
?>
  ...
  <script>
    ...
    function openUserReports() {
      window.location.href = "../webPage/admin2.php";
    }

    function openAllSavings() {
      window.location.href = "../webPage/admin3.php";
    }

    function openAllCheckings() {
      window.location.href = "../webPage/admin4.php";
    }
     function openPending() {
      window.location.href = "../webPage/adminConfirm.php";
    }
  </script>
