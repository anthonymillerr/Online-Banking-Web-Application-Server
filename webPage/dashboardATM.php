      ...
      <div class="card-inner">
        ...
        <div class="card-back">
          ...
          ?>
            ...
            <div class="cardrow">
              <p></p>
              <img class="visa" src="../assets/visa.png" width="80px">
            </div>
          </div>
        </div>
      </div>
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById("cancelBtn").addEventListener("click", function () {
                ...
                window.location.href = '../processingPages/logoutATM.php';
            });
        });
    </script>
    </div>
