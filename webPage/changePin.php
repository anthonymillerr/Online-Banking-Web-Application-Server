    ...
    if ($password === $user_data['password1'] && $securityresponse === $user_data['securityresponse']) {
        ...
        if ($old_pin === $user_data['Pin']) {
            ...
            if ($new_pin === $confirm_new_pin) {
                ...
                header("Location: changePin.php?success=1");
                exit();
            } else {
...
<body>
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <input type="password" name="securityresponse" id="securityresponse" required placeholder="Security Response">


        <label for="old_pin">Enter Old PIN:</label>
        <input type="password" name="old_pin" id="old_pin" required placeholder="Old Pin">


        <label for="new_pin">Enter New PIN:</label>
        <input type="password" name="new_pin" id="new_pin" required placeholder="New Pin">

        <label for="confirm_new_pin">Confirm New PIN:</label>
        <input type="password" name="confirm_new_pin" id="confirm_new_pin" required placeholder="Confirm New Pin">
